# Contribution Guideline ESMF Visual Studio Code Plugin Conde

Thank you for your interest in contributing to the ESMF Visual Studio Code Plugin Conde. Use this repository to contribute to
...
The ESMF Visual Studio Code Plugin Conde is developed in the context of the [Eclipse Semantic Modeling
...
# Code Conventions
The ESMF Visual Studio Code Plugin Conde is written in the Java Programming Language. Please have a look into our [Code
Conventions](CONVENTIONS.md).

## Versioning
We use Semantic Versioning to identify released versions of the ESMF Visual Studio Code Plugin Conde. Semantic Versioning is
